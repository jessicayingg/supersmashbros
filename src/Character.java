...
public class Character implements Comparable <Character>{
	...
	public Character(String name, double damage, double jump, double speed, Rectangle hitBox, Rectangle attackBox, Rectangle attackCharSize, int attackSpeed, int numAttackSprites, int numWalkSprites,  int walkAnimationSpeed)
	{
		this.name = name;
		this.baseDmg = damage;
		this.jumpSpeed = jump;
	...
	// Description: This method sets the special sprites based on the parameters given
	// Parameters: An ArrayList of sprite BufferedImages, a String indicating direction
	// Return: Void
	...
	// Description: This method updates a Character's hitbox, attacking box, and special box (range)
	// Parameters: The x and y coordinates of the Character, a boolean indicating whether or not
	...
	// Description: This method determines whether a Character has been hit by another Character's attack
	...
	// Description: This method determines whether a Character has been hit by another Character's special
	// Parameters: The Character using their special
	// Return: A boolean indicating whether or not the Character has been hit with the special
	...
	// Return: An integer determining the difference in the two Characters' number of wins
